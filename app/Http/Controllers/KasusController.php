...
class KasusController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $kasus->save();
        return redirect()->route('kasus.index')->with(['success'=>'Berhasil Di Input']);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $kasus->tanggal = $request->tanggal;
        $kasus->save();
        return redirect()->route('kasus.index')->with(['success'=>'Data <b>',$kasus->positif,'</b> Berhasil Di Edit']);
    }
    ...
    public function destroy($id)
    {
        $kasus = Kasus::findOrFail($id);
        $kasus->delete();
        return redirect()->route('kasus.index')->with(['success'=>'Data <b>',$kasus->positif,'</b> Berhasil Di Hapus']);
    }
}
