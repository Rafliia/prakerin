                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row ">
                            <div class="col-md-6">
                                ...
                                <input type="text" value="{{ $kasus->rw->desa->kecamatan->kota->nama_kota }}"
                                    class="form-control" readonly>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row ">
                            <div class="col-md-6">
                                ...
                                <input type="text" value="{{ $kasus->rw->desa->kecamatan->nama_kecamatan }}"
                                    class="form-control" readonly>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row ">
                            <div class="col-md-6">
                                ...
                                <input type="text" value="{{ $kasus->rw->desa->nama_desa }}" class="form-control"
                                    readonly>
                            </div>
                            <div class="col-md-6">
                                <label>Rw</label>
